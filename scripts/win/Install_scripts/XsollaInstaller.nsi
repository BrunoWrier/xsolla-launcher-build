...
!define PRODUCT_NAME "PixelTime" ;Launcher name in the Start menu. The value must be duplicated in the "product_name" parameter in the launcher/win/config.json file. 
